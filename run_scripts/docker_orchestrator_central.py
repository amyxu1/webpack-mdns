...
def main(argv):
    ...
    subprocess.Popen('/root/webpack-mdns/run_scripts/proxygen_static', shell=True)
    time.sleep(120)
    subprocess.run('python3 /root/webpack-mdns/run_scripts/auto_query.py '  + num_listen + ' ' + nic + ' '  + listen_webpacks, shell=True)
